...
<body>
    <nav class="fixed inset-x-0 top-0 z-30 mx-auto w-full max-w-screen border border-gray-100 bg-[#864ac2] py-5 px-8 shadow backdrop-blur-lg">
        <div class="px-4">
                ...
                <div class="flex shrink-0 md:gap-36">
                    ...
                    <div class="flex items-center justify-between gap-5 md:flex md:gap-40">
                        ...
                        <div class="flex gap-10 md:items-center md:justify-center">
                            ...
                            <select name="categorie" id="categorie" class="text-white bg-[#864ac2]"></select>
                        </div>
                    </div>
                </div>
