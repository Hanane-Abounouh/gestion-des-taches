...
<div class="hidden md:flex flex-col w-64 bg-gray-800 rounded-2xl">
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        <nav class="flex flex-col flex-1 overflow-y-auto bg-gradient-to-b from-[#864ac2] to-[#6e3777] px-2 py-4 gap-16 rounded-2xl">
            <div>
                <h6  class="flex items-center px-4 py-2 text-gray-100 hover:bg-[#694290]">
            ...
            <div class="flex flex-col flex-1 gap-5"> 
                ...
                <a href="./profile.php" class="flex sidebar-link items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                ...
                <a href="./Tâche.php" class="flex sidebar-link items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                ...
                <a href="./user.php" class="flex sidebar-link items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" style="margin-right: 8px">
                ...
                <a href="./Catégorie.php" class="flex sidebar-link items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="margin-right: 8px">
...
<div class="flex flex-col flex-1 overflow-y-auto">
    <div class="flex items-center justify-between h-16 bg-white border-b border-gray-200">
        <div class="flex items-center px-5">
            ...
            <div class="relative mx-auto  text-gray-600">
                <input class="border border-gray-300 h-10 w-96 px-8 pr-16 rounded-lg text-sm placeholder-current focus:outline-none dark:bg-gray-500 dark:border-gray-50 dark:text-gray-200"
                       type="search" name="search" placeholder="   Search">
                <button type="submit" class="absolute left-3 top-0 mt-3 mr-4">
    ...
    <div id="main-content" class=" px-12 flex flex-col flex-1 overflow-y-auto">
    <!-- Contenu principal sera chargé ici -->
</div>
</div>
